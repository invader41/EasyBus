...
-(void)searchStationsByName:(NSString *)stationName Success:(void (^)(NSArray *))success Failure:(void (^)(NSError *))failure
{
    ...
    NSDictionary *parameters = @{@"__VIEWSTATE":@"/wEPDwULLTE5ODM5MjcxNzlkZG5FgcZjEw/Xcik6rLaQKQqjiJG1N/LcEaJpbqk1zMfT",
...
{    
    ...
    NSString *bodystring = [NSString stringWithFormat:@"__VIEWSTATE=/wEPDwUJNDk3MjU2MjgyD2QWAmYPZBYCAgMPZBYCAgEPZBYCAgYPDxYCHgdWaXNpYmxlaGRkZArYd9NZeb6lYhNOScqHVvOmnKWkIejcJ7J2157Nz6l1&__VIEWSTATEGENERATOR=964EC381&__EVENTVALIDATION=/wEWAwL5m9CTDgL88Oh8AqX89aoKFjHWxIvicIW2NoJRKPFu7zDvdWiw74UWlUePz1dAXk4=&ctl00$MainContent$LineName=%@&ctl00$MainContent$SearchLine=搜索",bus];
